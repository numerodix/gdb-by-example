...
```
{{<snippets/unsigned-char,indent:-4>}}
```
...
```
{{<snippets/unsigned-short,indent:-4>}}
```
...
```
{{<snippets/unsigned-int,indent:-4>}}
```
...
```
{{<snippets/unsigned-long-long,indent:-4>}}
```
